...
namespace DNSServer {
    class DNSDatagram {
        ...
        private byte[] body =
            {0x04, 0x70, 0x6c, 0x61, 0x79, 0x06, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01};
        //{0x04, 0x77, 0x65, 0x62, 0x2e, 0x77, 0x68, 0x61, 0x74, 0x73, 0x61, 0x70, 0x70, 0x2e, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01};
        ...
        public byte[] asByteArray(String url)
        {
            //body = GetBytesInt16(url);
